<template>
    <q-page padding>
        <p class="page-title">Exams Marks for Job Applications</p>
                            ...
                            <div class="flex items-center">
                                ...
                                <q-btn-dropdown rounded flat dropdown-icon="more_vert" class="q-pa-sm">
                                    <q-list class="q-pa-sm">
                                        <q-item v-close-popup clickable  @click="$inertia.get(route('exams.marks.show', item.id))">
                                            <q-item-section><q-item-label>Assign Marks</q-item-label></q-item-section>
                                        </q-item>
                                    </q-list>
                                </q-btn-dropdown>
                            </div>
...
const handleSearch=e=>{
    router.get(route('exams.marks.index'), {
        search: state.search
    });
