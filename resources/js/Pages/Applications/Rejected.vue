<template>
    <q-page padding>
        <p class="page-title">Jobs Rejected List</p>
                            ...
                            <div class="flex items-center">
                                ...
                                <q-btn-dropdown rounded flat dropdown-icon="more_vert" class="q-pa-sm">
                                    <q-list class="q-pa-sm">
                                        <q-item v-close-popup clickable  @click="$inertia.get(route('admin.applications.show_rejected', item.id))">
...
const handleSearch=e=>{
    router.get(route('admin.applications.index_submission'), {
        search: state.search
    });
