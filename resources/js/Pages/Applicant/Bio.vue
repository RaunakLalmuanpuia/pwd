...
const form = useForm({
    ...
    // mizo_proficiency: Boolean(props.existingData?.disability) ? '1' : '0',
    ...
    // disability: Boolean(props.existingData?.disability),
    // disability: Boolean(props.existingData?.disability) ? 'Yes' : 'No',
    // disability: props.existingData?.disability ? 1 : 0, // Default to 1 (Yes) or 0 (No)

    disability: props.existingData?.disability ? 1 : 0, // Ensure it's a number
