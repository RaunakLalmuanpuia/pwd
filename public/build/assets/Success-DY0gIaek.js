import{x as q,S as j,U as N,o as S,d as z,w as T,s as Q,b as s,t as i,a as c,m as b,n as I,e as P,V as B}from"./app-SEr1oTYn.js";import{Q as E}from"./QPage-BwDfpGDS.js";import{A as M}from"./ApplicantLayout-BNtMtVRi.js";import{u as U}from"./use-quasar-Dj_8__oh.js";import"./QLayout-Cvqj20zm.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const V={class:"full-print flex justify-center items-center"},O={style:{"max-width":"480px"},class:"row zcard q-pa-md"},X={class:"col-xs-12 col-sm-9 text-weight-medium"},F={class:"col-xs-12 col-sm-9 text-weight-medium"},H={class:"col-xs-12 col-sm-9 text-weight-medium"},L={class:"col-xs-12 col-sm-9 text-weight-medium"},R={class:"col-xs-12 col-sm-9 text-weight-medium"},$={class:"col-xs-12"},J={class:"col-xs-12 col-sm-9 text-weight-medium"},W={class:"col-xs-12 col-sm-9 text-weight-medium"},G={class:"col-xs-12 col-sm-9 text-weight-medium"},K={class:"col-xs-12 col-sm-9 text-weight-medium"},Y={class:"col-xs-12"},Z={class:"col-xs-12 print-hide"},rt=Object.assign({layout:M},{__name:"Success",setup(tt){const d=U(),A=q(),e=j({resultInfo:{},txnId:"",txnAmount:"",txnDate:"",reference:{}}),D=async o=>{var t,r;d.loading.show();try{const{data:n}=await Q.get(route("transaction.checkStatus",{order_id:o})),{body:l,reference:a}=n;Object.assign(e.resultInfo,l.resultInfo),e.txnId=l.txnId,e.txnAmount=l.txnAmount,e.txnDate=l.txnDate,e.reference=a}catch(n){d.notify({type:"negative",message:((r=(t=n.response)==null?void 0:t.data)==null?void 0:r.message)||n.message})}finally{d.loading.hide()}},C=()=>{var o;((o=e.resultInfo)==null?void 0:o.resultStatus)!=="TXN_SUCCESS"&&B.get(route("application.viewApplicationDraft",e.reference.job_detail.id))},k=()=>{const o=document.querySelector(".full-print").innerHTML,t=window.open("","_blank");t.document.open(),t.document.write(`
        <html>
        <head>
            <title>Print</title>
